...
const adminLinks = [
  ...
  { href: "/admin/manual-orders", label: "Manual Orders", icon: Package },
...
export function AdminLayout() {
  ...
  const pageMeta = useMemo(() => {
    ...
    const routeMeta: Array<{
      ...
      { path: '/admin/manual-orders', title: 'Manual Orders', description: 'Create phone/WhatsApp orders and send instant bills.' },
