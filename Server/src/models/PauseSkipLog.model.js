...
const REQUEST_TYPES = ['PAUSE', 'SKIP'];
...
const PauseSkipLogSchema = new mongoose.Schema(
  {
    requestType: { type: String, required: true, enum: REQUEST_TYPES, index: true },
    status: { type: String, required: true, enum: REQUEST_STATUSES, default: 'PENDING', index: true },
